...
| Benchmark Browser Task Registry | [benchmark-browser-task-registry.md](benchmark-browser-task-registry.md) | Curated registry | BER-173 machine-readable benchmark-derived browser task registry covering warmup, core research, hardening/repair, and eval/probe stages |
| HF Benchmark Data Import | [hf-benchmark-data-import.md](hf-benchmark-data-import.md) | Draft import plan | BER-175 simplified benchmark-first import policy for Hugging Face/public datasets, direct train/dev use where licensed, split/provenance labels, and custom untouched test |
| HF Dataset Schema-Fit Probe | [hf-dataset-schema-fit-probe.md](hf-dataset-schema-fit-probe.md) | Schema-fit gate | BER-176 tiny dataset suitability audit; recommends Mind2Web as first adapter target and quarantines env/gated/large-media risks before ingestion |
| BER-173 Raw-Student Ranking Results | [ber-173-raw-student-ranking-results.md](ber-173-raw-student-ranking-results.md) | Pilot results | Empirical raw-student ranking pilots showing a narrow Stage-1 official-doc frontier and recovery/finalization blockers |
